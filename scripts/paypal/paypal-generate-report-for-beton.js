...
const CLIENT_ID = process.env.PAYPAL_CLIENT_ID_BETON;
const SECRET = process.env.PAYPAL_SECRET_BETON;
const DOWNLOAD_DIR = process.env.DOWNLOAD_PATH || './downloads';
const PAYPAL_FOLDER = path.join(DOWNLOAD_DIR, 'PayPal/Betonwaschbecken');
